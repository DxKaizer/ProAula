...
const postConsulta = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { body } = req;
    try {
        yield consultaEs_1.default.create(body);
        res.json({
